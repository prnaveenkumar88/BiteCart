<%@ page import="java.util.*, com.BiteCart.Modal.Menu, com.BiteCart.DAOImpl.MenuDAOImpl, com.BiteCart.DAOImpl.RestaurantDAOImpl, com.BiteCart.Modal.Restaurant, com.BiteCart.Modal.OrderItems" %>
<%@ page contentType="text/html;charset=UTF-8" language="java" %>

<%
    // ✅ Get restaurant ID and store in session if needed
...
<div class="header">
    <h1><%= restaurant != null ? restaurant.getRestaurantName() : "Restaurant" %> - Menu</h1>
</div>
